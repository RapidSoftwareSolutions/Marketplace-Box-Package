...
$app->post('/api/Box/createGroup', function ($request, $response) {
    ...
    $optionalParam = ['provenance'=>'provenance', 'externalSyncIdentifier'=>'external_sync_identifier','description'=>'description'];
