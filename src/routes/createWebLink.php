...
$app->post('/api/Box/createWebLink', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['accessToken','url','parentId']);
    ...
    $optionalParam = ['name'=>'name' ,'description'=>'description'];
    ...
    $query_str = $settings['default_url'] . "web_links";
