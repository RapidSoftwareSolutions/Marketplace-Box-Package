...
$app->post('/api/Box/deleteOldFileVersion', function ($request, $response) {
    ...
    $query_str = $settings['files_url'] . $fileId . '/versions/' . $id;
    ...
    try {
        ...
        if(in_array($resp->getStatusCode(), ['200', '201', '202', '203', '204'])) {
            ...
            if(empty($result['contextWrites']['to'])) {
                $result['contextWrites']['to']['status_msg'] = "Version deleted";
            }
        } else {
