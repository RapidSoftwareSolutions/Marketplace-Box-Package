...
$app->post('/api/Box/getEnterpriseTemplates', function ($request, $response) {
    ...
    $data= [];
    $optionalParam = ['marker'=>'marker', 'limit'=>'limit'];
    ...
    $query_str = $settings['default_url'] . "metadata_templates/enterprise/";
