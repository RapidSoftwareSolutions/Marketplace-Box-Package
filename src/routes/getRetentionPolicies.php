...
$app->post('/api/Box/getRetentionPolicies', function ($request, $response) {
    ...
    if(!empty($post_data['args']['policyType'])){
        $data['policy_type'] = $post_data['args']['policyType'];
    }
    if(!empty($post_data['args']['createdByUserId'])){
        $data['created_by_user_id'] = $post_data['args']['createdByUserId'];
    }
