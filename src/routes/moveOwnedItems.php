...
$app->post('/api/Box/moveOwnedItems', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['accessToken','userId','folderId','ownedById']);
    ...
    $data= [];
    $optionalParam = ['notify'=>'notify', 'fields'=>'fields'];
